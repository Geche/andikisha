...
const SECTIONS = [
  ...
  { title: "4. Third-party services", body: `AndikishaHR generates statutory returns (PAYE/P10A, NSSF, SHIF, Housing Levy) in the formats required by the relevant authorities. You file them — we do not transmit data to KRA, NSSF, or SHIF on your behalf, and we do not collect or store your credentials for those portals. We use infrastructure providers (cloud hosting, email delivery) who are contractually bound to data processing standards consistent with this policy.` },
