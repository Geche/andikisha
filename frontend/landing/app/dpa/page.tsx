...
const SECTIONS = [
  ...
  { title: "3. Nature and purpose of processing", body: `Processing activities include: calculating statutory deductions (PAYE, NSSF, SHIF, Housing Levy), generating payslips, filing statutory returns with KRA and other bodies, maintaining employment records, and providing HR management tools. All processing is performed exclusively to deliver the contracted service.` },
  ...
  { title: "8. Sub-processors", body: `AndikishaHR uses the following categories of sub-processors: cloud infrastructure providers (data hosted in East Africa), email delivery services for system notifications, and KRA iTax API for statutory filing. The Controller will be notified of any material changes to sub-processors with at least 30 days' notice.` },
