...
export default function ContactPage() {
  return (
    <>
      ...
      {/* Two-column: left = form, right = contact details */}
      <section className="py-20 bg-surface-alt">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            {/* Left — Contact form */}
            <div className="bg-white rounded-2xl border border-ink-200 p-8 shadow-[0_8px_40px_rgba(11,61,46,0.06)]">
            ...
            <div>
              ...
              <p className="text-[16px] text-ink-600 leading-relaxed mb-10">
                Our team is in Nairobi (EAT, UTC+3). We are available Monday to
                Friday, 8am – 6pm. For urgent payroll issues, we also offer
                weekend support on Growth and Scale plans.
              </p>
              ...
              <div className="flex flex-col gap-6 mb-10">
                {CONTACT_ITEMS.map((item) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="text-[12px] font-semibold uppercase tracking-wider text-ink-400 mb-0.5">
                        {item.label}
                      </p>
                      <p className="text-[16px] font-medium text-ink-900 group-hover:text-brand-700 transition-colors duration-200">
                        {item.value}
                      </p>
                    </div>
                  </a>
