...
const SECTIONS = [
  ...
  { title: "4. Statutory filing", body: `AndikishaHR generates statutory returns from your payroll data and formats them for submission. You file them with the relevant authority — AndikishaHR does not submit returns on your behalf and does not act as your filing agent. You remain the legal taxpayer and employer responsible for statutory compliance, and you are responsible for reviewing generated returns for accuracy before filing. Liability for incorrect filings, including those resulting from inaccurate data, rests with the employer.` },
