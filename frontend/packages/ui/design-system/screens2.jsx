  ...
  return (
    <div style={{ display: "flex", height: "100%", fontFamily: "var(--font-sans)" }}>
      ...
      <div style={{ flex: 1, background: "linear-gradient(150deg, var(--green-900), var(--green-700))", color: "#fff",
        ...
        <div style={{ position: "absolute", right: -60, bottom: -60, width: 240, height: 240, borderRadius: "50%", background: "rgba(232,160,32,0.12)" }} data-comment-anchor="dcfb776a21-div-176-9" />
      </div>
    </div>);
