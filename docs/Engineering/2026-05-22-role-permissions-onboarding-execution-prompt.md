...
**Companion plan:** `docs/Engineering/2026-05-22-role-permissions-onboarding-plan.md`. Read it before starting. This prompt is the execution document for that plan.
