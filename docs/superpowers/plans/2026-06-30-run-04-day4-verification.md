...
- **Verification report output:** append results to `docs/audits/2026-06-30-run-04-day4-verification-report.md` (created in Task B0).
...
Add a row to `docs/audits/2026-06-30-run-04-day4-verification-report.md`: "Past-date leave accepted for non-retroactive types — characterization test added; rule decision pending (see plan A1)."

- [ ] **Step 4: Commit**

```bash
git add services/leave-service/src/test/java/com/andikisha/leave/unit/LeaveServiceTest.java docs/audits/2026-06-30-run-04-day4-verification-report.md
...
git add services/auth-service/src/test docs/audits/2026-06-30-run-04-day4-verification-report.md
...
**Files:**
- Create: `docs/audits/2026-06-30-run-04-day4-verification-report.md`
...
Create `docs/audits/2026-06-30-run-04-day4-verification-report.md` with a section per task below (B1–B8 + A1/A2 findings), each with: Flow, Steps run, Expected, Observed, Screenshot, **PASS/FAIL/BLOCKED**.
...
```bash
git add docs/audits/2026-06-30-run-04-day4-verification-report.md
