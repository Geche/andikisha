...
The home page was fully redesigned in May 2026 (see `docs/superpowers/specs/2026-05-07-landing-redesign-design.md`). The secondary pages need to match the same visual quality: Bricolage Grotesque headlines, brand-900/950 hero backgrounds, amber accents, single "Schedule a demo" primary CTA, and closing every page with either `JoinCTA` or `NewsletterSection`.
