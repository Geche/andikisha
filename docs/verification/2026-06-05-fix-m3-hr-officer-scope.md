...
**Date:** 2026-06-05  
**Commit:** `f3cbddd`  
**Source:** M-3 in `docs/audits/2026-06-03-bug-hunt-inventory.md`  
...
The `docs/product/andikishaHR-report-02-release-02-new-services.md` reference to "HR Managers and HR Officers" remains accurate (HR Officers = HR_OFFICER role, now fully operational). No update needed.

The `docs/plans/2026-05-22-role-permissions-onboarding-plan.md` §5.3 statement "only ADMIN, HR_MANAGER, HR_OFFICER (whoever has `employee:write` capability)" is now satisfied: HR_OFFICER has `employee:update:all` in seed and is in the controller @PreAuthorize for PUT.
