...
The actual menu inventory lives in `andikishahr-portal-menus-v2.md` at the repo root. This document is not a duplicate; it is the contract that says how the menu inventory becomes code.
...
The answer is in `andikishahr-portal-menus-v2.md`. Read it before generating any navigation config, route guard, or conditional rendering logic.
...
Reading `andikishahr-portal-menus-v2.md` surfaces these patterns. The shared library must support all of them.
...
Each prompt that touches menus or guards reads this document and `andikishahr-portal-menus-v2.md` together.
...
If `andikishahr-portal-menus-v2.md` gets updated (new menu item, changed visibility rule, new tier gate), three things follow:
...
This document is not the menu inventory itself. The inventory is in `andikishahr-portal-menus-v2.md`. This document is the contract between the inventory and the code.
...
- `andikishahr-portal-menus-v2.md` — the canonical menu inventory (what items exist, who sees them)
...
- `docs/design/template-usage.md` — long-form template policy
- `docs/adr/0001-single-tenant-portal.md` — frontend consolidation decision
- `docs/adr/0002-platform-portal-separation.md` — platform-portal separation decision
