...
> **Correction (2026-06-29) — this conclusion was wrong.** The "387,600" annual basis above is not a KRA figure. KRA defines Band 2 as the **next KES 8,333 after the first 24,000** (24,001–32,333 @ 25%); the annual ceiling is 288,000 + 100,000 = **388,000 ÷ 12 = 32,333.33**, gazetted monthly as **32,333** (confirmed against kra.go.ke). The 32,300 constant under-stated the ceiling by 33 and slightly over-deducted PAYE for incomes above the band. `BAND_2_LIMIT` is now **32,333**, the seeded compliance rates are corrected by migration `V6__correct_paye_band2_ceiling.sql`, and the regression guards now assert 32,333. The deeper learning: an "investigation" that cites an unsourced figure is not a verification — confirm against the gazetted source. (COMPLIANCE-BACKLOG-002 / Run-04 B-12.)
