...
dependencies {
    ...
    // Messaging — publishes AttendanceRecordedEvent; listens to EmployeeCreatedEvent
    implementation("org.springframework.boot:spring-boot-starter-amqp")

    // gRPC — server (attendance data) + client (calls employee-service to verify employee)
