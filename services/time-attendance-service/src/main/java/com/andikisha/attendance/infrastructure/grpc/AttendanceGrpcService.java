    ...
    public void getMonthlyHours(GetMonthlyHoursRequest request,
        ...
        try {
            ...
            observer.onNext(MonthlyHoursResponse.newBuilder()
                    ...
                    .setRegularHours(summary.regularHours().toPlainString())
                    .setOvertimeWeekday(summary.overtimeWeekday().toPlainString())
                    .setOvertimeWeekend(summary.overtimeWeekend().toPlainString())
                    .setOvertimeHoliday(summary.overtimeHoliday().toPlainString())
