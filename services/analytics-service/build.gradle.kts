...
dependencies {
    ...
    // Redis — caching computed report results
    implementation("org.springframework.boot:spring-boot-starter-data-redis")
    implementation("org.springframework.boot:spring-boot-starter-cache")

    // Database — analytics read model / materialized views
    runtimeOnly("org.postgresql:postgresql")
    implementation("org.flywaydb:flyway-core")
    implementation("org.flywaydb:flyway-database-postgresql")

    // Messaging — subscribes to all domain events to build analytics projections
    implementation("org.springframework.boot:spring-boot-starter-amqp")

    // gRPC client — pulls raw data from payroll-service, employee-service, leave-service
